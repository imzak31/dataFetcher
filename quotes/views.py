...
def home(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + ticker + "/quote?token=pk_b6e484d7335d442a94d6818351f3426f")
		# api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + ticker + "pk_b6e484d7335d442a94d6818351f3426f")
		...
		return render(request, 'home.html', {'ticker': "Introduzca un Simbolo Bursatil"})
...
def add_stock(request):
	...
	if request.method == 'POST':
		...
		for ticker_item in ticker:
			api_request = requests.get("https://cloud.iexapis.com/stable/stock/" + str(ticker_item) + "/quote?token=</pk_b6e484d7335d442a94d6818351f3426f >")
			try:
				api = json.loads(api_request.content)
				output.append(api)
			except Exception as e:
...
def news(request):
	...
	api_request = requests.get('https://stocknewsapi.com/api/v1/category?section=alltickers&items=50&token=</pk_b6e484d7335d442a94d6818351f3426f >')
	api = json.loads(api_request.content)
